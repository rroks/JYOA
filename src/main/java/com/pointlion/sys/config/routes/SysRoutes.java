...
import com.pointlion.sys.mvc.admin.sys.template.SysTemplateparamController;
import com.pointlion.sys.mvc.admin.sys.template.TemplateController;
...
import com.pointlion.sys.mvc.admin.sys.cms.CmsController;
...
import com.pointlion.sys.mvc.admin.sys.mobileversion.SysMobileVersionController;
...
public class SysRoutes extends Routes{
	...
	public void config() {
		...
		add("/admin/login", LoginController.class);//登陆
		//系统管理
		...
		//手机端版本控制
		add("/admin/sys/mobileversion",SysMobileVersionController.class,"mobileversion");
		//模板自定义
		add("/admin/sys/template", TemplateController.class,"template");
		add("/admin/sys/templateparam", SysTemplateparamController.class,"template");
	}
