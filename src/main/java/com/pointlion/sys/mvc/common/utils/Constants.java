...
public class Constants {
	...
	public static final String IF_CUSTOMFLOW_YES="1";//是否自定义审批
	public static final String IF_CUSTOMFLOW_NO="0";//是否自定义审批
	...
	public static final String CurrentUser_Org_Id = "$CurrentUser_Org_id$";//当前登陆人，所在部门的id
	public static final String CurrentUser_Org_ParentChildCompanyId = "$CurrentUser_Org_ParentChildCompanyId$";//当前登陆人，所在部门的所属子公司id
	public static final String CurrentUser_Id = "$CurrentUser_Id$";//当前登陆人的id
