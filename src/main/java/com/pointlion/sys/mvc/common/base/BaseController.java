...
public abstract class BaseController extends Controller {
	...
	public void renderSuccess(Object data, String description) {
	  ...
	  public void renderSuccess800(Object data, int dataSize, String description, Object obj) {
	        RenderBean renderBean = new RenderBean();
	        renderBean.setSuccess(true);
	        renderBean.setCode("800");
	        renderBean.setData(data);
	        renderBean.setData1(obj);
	        renderBean.setTotal(dataSize);
	        if (StrKit.isBlank(description)) {
	            renderBean.setMessage(messageSuccess);
	        } else {
	            renderBean.setMessage(description);
	  ...
	  public void renderSuccess800(Object data, int dataSize, String description) {
	        RenderBean renderBean = new RenderBean();
	        renderBean.setSuccess(true);
	        renderBean.setCode("800");
	        renderBean.setData(data);
    ...
    public void renderError900(String message) {
        RenderBean renderBean = new RenderBean();
        renderBean.setCode("900");
        renderBean.setSuccess(true);
        renderBean.setMessage(message);
        renderJson(renderBean);
    }
