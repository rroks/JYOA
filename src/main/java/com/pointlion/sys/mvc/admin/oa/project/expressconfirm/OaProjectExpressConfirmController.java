package com.pointlion.sys.mvc.admin.oa.project.expressconfirm;
...
import com.pointlion.sys.mvc.common.model.OaProjectExpressConfirm;
...
public class OaProjectExpressConfirmController extends BaseController {
	...
	public void getListPage(){
		setBread("项目单据快递确认申请",this.getRequest().getServletPath(),"项目单据快递确认申请");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("项目单据快递确认申请",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","项目单据快递确认申请");
    ...
    public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_PROJECT_EXPRESS_CONFIRM,null,null);
