...
public class OaProjectController extends BaseController {
	...
	public void getApplyListPage(){
		setBread("项目管理",this.getRequest().getServletPath(),"管理");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("项目管理",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getApplyListPage","申请单");
    	//添加和修改
    ...
    public void openSelectOneProjectDialog(){
    	render("selectOneProjectDialog.html");
    }
    /**************************************************************************/
