package com.pointlion.sys.mvc.admin.ams.need;
...
import com.pointlion.sys.mvc.common.model.AmsAssetNeed;
...
public class AmsAssetNeedController extends BaseController {
	...
	public void getListPage(){
		setBread("资产需求",this.getRequest().getServletPath(),"资产需求");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("资产需求",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","资产需求");
	...
	public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_AMS_NEED,null,null);
