...
public class AmsAssetDisposeController extends BaseController {
	...
	public void getListPage(){
		setBread("资产处置",this.getRequest().getServletPath(),"资产处置");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("资产处置",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","资产处置");
	...
	public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_AMS_DISPOSE,null,null);
