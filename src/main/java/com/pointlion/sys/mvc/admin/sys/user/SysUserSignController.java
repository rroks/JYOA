...
public class SysUserSignController extends BaseController {
	public static final SysUserSignService service = SysUserSignService.me;
     ...
     */
    public void save(){
    	SysUserSign o = getModel(SysUserSign.class);
...
//    		o.setCreateTime(DateUtil.getTime());
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		SysUserSign o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
...
//    			}
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(SysUserSign.class.getSimpleName()));//模型名称
    	render("edit.html");
    }
    /***
     * 删除
