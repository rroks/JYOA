...
public class OaApplyTrainTicketController extends BaseController {
	...
	public void getApplyListPage(){
		setBread(controllerName,this.getRequest().getServletPath(),"管理");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread(controllerName,this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getApplyListPage","领用起草");
    	//添加和修改
    ...
    public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_APPLY_TRAINTICKET,o.getTitle(),null);
