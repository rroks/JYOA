...
public class DctResourceMeetroomController extends BaseController {
	...
	public void getListPage(){
		setBread("会议室管理",this.getRequest().getServletPath(),"管理");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("会议室管理",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","领用起草");
    	//添加和修改
