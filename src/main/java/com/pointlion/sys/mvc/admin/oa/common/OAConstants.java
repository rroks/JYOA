...
public class OAConstants {
	 ...
	 * 流程中会用的角色
	 */
	public static final String WORKFLOW_ROLE_KEY_ProLeader = "XMJL";//项目经理
	...
	//流程条件中用的
	public static final String WORKFLOW_VAR_APPLY_VAR_MY_ORG_LEADER_EXIT = "OrgLeaderexit";//该流程发起单位是否有部门经理，"0"不存在，"1"存在
	public static final String WORKFLOW_VAR_APPLY_VAR_XMJL_EXIT = "XMJLexit";//该流程发起单位是否有项目经理，"0"不存在，"1"存在
	...
	public static final String WORKFLOW_VAR_APPLY_MY_PROJECT_LEADER = "applyMYProjectLeader";//【所有流程可用】，项目经理,申请人所在项目的项目经理，没有则无需项目经理审批。
	 ...
	 * 自定义审批当中的状态
	 */
	public static final String OA_CUSTOM_CASE_STATE_RUN = "1"; //运行中
	public static final String OA_CUSTOM_CASE_STATE_BACK = "2";//退回
	public static final String OA_CUSTOM_CASE_STATE_AGREE = "3";//同意
	public static final String OA_CUSTOM_CASE_STATE_DISAGREE = "4";//不同意
	public static final String OA_CUSTOM_CASE_STATE_RECALL = "5";//撤回

	public static final String OA_CUSTOM_CASENODE_STATE_RUN = "1";//执行中
