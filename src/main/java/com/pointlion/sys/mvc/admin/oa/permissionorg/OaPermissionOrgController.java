...
public class OaPermissionOrgController extends BaseController {
	public static final OaPermissionOrgService service = OaPermissionOrgService.me;
     ...
     */
    public void save(){
    	OaPermissionOrg o = getModel(OaPermissionOrg.class);
...
//    		o.setCreateTime(DateUtil.getTime());
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaPermissionOrg o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
...
//    			}
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaPermissionOrg.class.getSimpleName()));//模型名称
    	render("edit.html");
    }
    /***
     * 删除
