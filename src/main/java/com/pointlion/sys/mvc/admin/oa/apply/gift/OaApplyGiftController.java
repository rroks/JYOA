package com.pointlion.sys.mvc.admin.oa.apply.gift;
...
import com.pointlion.sys.mvc.common.model.OaApplyGift;
...
public class OaApplyGiftController extends BaseController {
	...
	public void getApplyListPage(){
		setBread("礼品申请",this.getRequest().getServletPath(),"管理");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("礼品申请",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getApplyListPage","领用起草");
    	//添加和修改
    ...
    public void startProcess() throws ClassNotFoundException, InstantiationException, IllegalAccessException{
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_APPLY_GIFT,o.getTitle(),null);
