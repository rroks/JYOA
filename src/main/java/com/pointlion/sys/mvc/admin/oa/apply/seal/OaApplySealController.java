package com.pointlion.sys.mvc.admin.oa.apply.seal;
...
import com.pointlion.sys.mvc.common.model.OaApplySeal;
...
public class OaApplySealController extends BaseController {
	...
	public void getApplyListPage(){
		setBread("公章申请",this.getRequest().getServletPath(),"管理");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("公章申请",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getApplyListPage","领用起草");
    	//添加和修改
    ...
    public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_APPLY_SEAL,o.getTitle(),null);
