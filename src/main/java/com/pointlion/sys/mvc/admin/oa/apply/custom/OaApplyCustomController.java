package com.pointlion.sys.mvc.admin.oa.apply.custom;
...
public class OaApplyCustomController extends BaseController {
	...
	public void getListPage(){
		setBread("自定义流程任务",this.getRequest().getServletPath(),"自定义流程任务");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	...
    	setAttr("defKey", defKey);
    	setBread("自定义流程任务",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","自定义流程任务");
