...
import com.pointlion.sys.mvc.admin.sys.template.SysTemplateparamService;


@Before(MainPageTitleInterceptor.class)
public class SysTemplateparamController extends BaseController {
    public static final SysTemplateparamService service = SysTemplateparamService.me;
    ...
    public void listData(){
        ...
        String parammodule = getPara("moduleame","");
        Page<Record> page = service.getPage(Integer.valueOf(curr),Integer.valueOf(pageSize),paramname,parammodule);
     ...
     */
    public void save(){
        SysTemplateparam o = getModel(SysTemplateparam.class);
    ...
    public void getEditPage(){
        ...
        if(StrKit.notBlank(id)){//修改
            SysTemplateparam o = service.getById(id);
            setAttr("o", o);
            //是否是查看详情页面
        ...
        setAttr("formModelName",StringUtil.toLowerCaseFirstOne(SysTemplateparam.class.getSimpleName()));//模型名称
        render("edit.html");
    }
    /***
     * 删除
