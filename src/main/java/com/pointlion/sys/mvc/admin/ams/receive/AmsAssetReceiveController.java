...
public class AmsAssetReceiveController extends BaseController {
	...
	public void getListPage(){
		setBread("资产领用",this.getRequest().getServletPath(),"资产领用");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("资产领用",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","资产领用");
	...
	public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_AMS_RECEIVE,null,null);
