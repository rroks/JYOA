package com.pointlion.sys.mvc.admin.oa.contract.invoice;
...
import com.pointlion.sys.mvc.common.model.OaContractInvoice;
...
public class OaContractInvoiceController extends BaseController {
	...
	public void getListPage(){
		setBread("合同开票申请",this.getRequest().getServletPath(),"合同开票申请");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("合同开票申请",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","合同开票申请");
    ...
    public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_CONTRACT_INVOICE,null,null);
