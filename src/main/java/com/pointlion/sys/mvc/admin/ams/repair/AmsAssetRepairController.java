package com.pointlion.sys.mvc.admin.ams.repair;
...
import com.pointlion.sys.mvc.common.model.AmsAssetRepair;
...
public class AmsAssetRepairController extends BaseController {
	...
	public void getListPage(){
		setBread("资产报修",this.getRequest().getServletPath(),"资产报修");
    	render("list.html");
    }
	/***
     * 获取分页数据
    ...
    public void getEditPage(){
    	setBread("资产报修",this.getRequest().getServletPath().substring(0,this.getRequest().getServletPath().lastIndexOf("/")+1)+"getListPage","资产报修");
	...
	public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, OAConstants.DEFKEY_AMS_REPAIR,null,null);
